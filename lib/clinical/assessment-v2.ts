...
export type SchoolLearningContext = "reading_aloud" | "silent_reading" | "text_comprehension" | "dictation" | "spontaneous_writing" | "structured_writing" | "calculation_task" | "schoolwork_observation";
export type SchoolLearningArea = "reading_accuracy" | "reading_fluency" | "reading_comprehension" | "spelling" | "written_text" | "number_processing" | "calculation";
export type SchoolLearningFeature = "reading_errors" | "slow_or_effortful_reading" | "reduced_reading_comprehension" | "spelling_errors" | "written_text_organization_difficulty" | "number_processing_difficulty" | "calculation_difficulty" | "task_avoidance_or_fatigue";
export type SchoolLearningModuleV1 = { profile?: { status: ClinicalObservationStatus; contextsExplored?: SchoolLearningContext[]; exploredAreas?: SchoolLearningArea[]; observedFeatures?: SchoolLearningFeature[]; notes?: string } };
export type CognitiveCommunicationContext = "conversation" | "structured_task" | "multistep_activity" | "narrative_task" | "functional_daily_task" | "dual_task_or_distractors";
export type CognitiveCommunicationArea = "communicative_attention" | "verbal_working_memory" | "auditory_verbal_memory" | "information_processing" | "message_planning" | "organization" | "cognitive_flexibility" | "self_monitoring";
export type CognitiveCommunicationFeature = "loses_track_of_conversation" | "difficulty_retaining_verbal_information" | "difficulty_following_multistep_information" | "slowed_information_processing" | "message_planning_difficulty" | "disorganized_information" | "reduced_flexibility" | "reduced_self_monitoring" | "distractibility_during_communication";
export type CognitiveCommunicationModuleV1 = { profile?: { status: ClinicalObservationStatus; contextsExplored?: CognitiveCommunicationContext[]; exploredAreas?: CognitiveCommunicationArea[]; observedFeatures?: CognitiveCommunicationFeature[]; notes?: string } };
export type SocialPragmaticsContext = "spontaneous_interaction" | "conversation" | "structured_interaction" | "play_activity" | "group_context" | "interaction_with_familiar_partner" | "interaction_with_unfamiliar_partner";
export type SocialPragmaticsArea = "communicative_initiation" | "reciprocity" | "turn_taking" | "topic_management" | "adaptation_to_partner" | "contextual_appropriateness" | "inferential_language" | "nonliteral_language" | "communication_repair" | "nonverbal_communication";
export type SocialPragmaticsFeature = "reduced_initiation" | "reduced_reciprocity" | "turn_taking_difficulty" | "topic_maintenance_difficulty" | "abrupt_topic_shifts" | "reduced_partner_adaptation" | "contextual_inappropriateness" | "inferential_difficulty" | "nonliteral_language_difficulty" | "communication_repair_difficulty" | "reduced_nonverbal_integration";
export type SocialPragmaticsModuleV1 = { profile?: { status: ClinicalObservationStatus; contextsExplored?: SocialPragmaticsContext[]; exploredAreas?: SocialPragmaticsArea[]; observedFeatures?: SocialPragmaticsFeature[]; notes?: string } };
