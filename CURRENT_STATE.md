...
- La Libreria terapeutica V2 e il relativo cutover sono completati. Prima della `015`, la reconciliation ha confermato assenza di orfani e mismatch, uguaglianza fra byte DB/Storage/quota e nessuna reservation pendente o in cleanup. Il postflight non ha rilevato modifiche a dati o file. Il collaudo reale post-cutover ha verificato upload e apertura PDF, associazione/rimozione paziente, delete con quota aggiornata e creazione/apertura di link quota-free; i collaudi precedenti coprono immagini, preview responsive, MP3, DOCX, formati vietati, limite file, quota/reservation e signed upload/finalize.
