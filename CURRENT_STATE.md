...
- Nessuna modifica locale presente al momento del controllo iniziale.
- Ultimo commit: `8d35adb` — “Corregge dashboard Oggi”.
- Commit precedenti rilevanti: `1548997` — Google Calendar e sedute retroattive; `6ce4d3e` — MVP cloud stabile.
...
- Gli appuntamenti ricorrenti non sono presenti nei tipi, nello schema o nell'interfaccia.
- `package.json` non espone uno script o una suite di test automatici.
- Il README elenca le migration fino alla `003`, mentre nel repository è presente anche la `004`; inoltre non documenta l'intera configurazione server-side Google per Vercel.
